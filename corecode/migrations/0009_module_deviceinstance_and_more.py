# Generated by Django 5.2 on 2025-09-19 13:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.ForeignKey(blank=True, help_text='소속 시설(Facility)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='agriseed.facility')),
                ('location_group', models.ForeignKey(blank=True, help_text='지역 그룹 연결 (선택)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='modules', to='corecode.locationgroup')),
            ],
            options={
                'ordering': ['order', 'id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('catalog', models.ForeignKey(blank=True, help_text='장비 카탈로그(Device) 참조', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='instances', to='corecode.device')),
                ('module', models.ForeignKey(blank=True, help_text='소속 모듈', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='devices', to='corecode.module')),
            ],
        ),
        migrations.AddIndex(
            model_name='module',
            index=models.Index(fields=['module_type'], name='corecode_mo_module__9801a3_idx'),
        ),
        migrations.AddIndex(
            model_name='module',
            index=models.Index(fields=['is_enabled'], name='corecode_mo_is_enab_63d94e_idx'),
        ),
        migrations.AddIndex(
            model_name='deviceinstance',
            index=models.Index(fields=['serial_number'], name='corecode_de_serial__afc8f3_idx'),
        ),
        migrations.AddIndex(
            model_name='deviceinstance',
            index=models.Index(fields=['status'], name='corecode_de_status_068be9_idx'),
        ),
        migrations.AddIndex(
            model_name='deviceinstance',
            index=models.Index(fields=['last_seen'], name='corecode_de_last_se_c01e98_idx'),
        ),
        migrations.AddIndex(
            model_name='deviceinstance',
            index=models.Index(fields=['catalog'], name='corecode_de_catalog_ab9d10_idx'),
        ),
