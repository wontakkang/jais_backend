...
class Digital_Input_Output_All_Read_RequestBase(DE_MCU_Request):
    """
    DE-MCU 노드 선택 요청 PDU 생성 클래스
    """

    name = "DIO_READ_ALL_REQ"
...
class Digital_Input_Output_All_Read_Request(Digital_Input_Output_All_Read_RequestBase):
    """
...
class Digital_Input_Output_All_Read_ResponseBase(DE_MCU_Response):
    """
    DE-MCU 노드 선택 응답 PDU 생성 클래스
    """

    name = "DIO_READ_ALL_RES"
...
class Digital_Input_Output_All_Read_Response(
    Digital_Input_Output_All_Read_ResponseBase
):
    """
    DE-MCU 노드 선택 요청 PDU 생성 클래스 (serial_number를 HEX 문자열로 입력받음)
    """
    ...
    def deserialize(self, data):
        ...
        processed_data.setdefault("STATUS", {}).setdefault("Digital_Input", {
            "DI1": {
                "Id": 1, "Value": res_data[0]
            },
            "DI2": {
                "Id": 2, "Value": res_data[1]
            },
            "DI3": {
                "Id": 3, "Value": res_data[2]
            },
            "DI4": {
                "Id": 4, "Value": res_data[3]
            },
            "DI5": {
                "Id": 5, "Value": res_data[0]
            },
            "DI6": {
                "Id": 6, "Value": res_data[1]
            },
            "DI7": {
                "Id": 7, "Value": res_data[2]
            },
            "DI8": {
                "Id": 8, "Value": res_data[3]
            },
        })
        
        processed_data.setdefault("STATUS", {}).setdefault("Digital_Output", {
            "DO1": {
                "Id": 1, "Value": res_data[8], "Current": res_data[16],
            },
            "DO2": {
                "Id": 2, "Value": res_data[9], "Current": res_data[17],
            },
            "DO3": {
                "Id": 3, "Value": res_data[10], "Current": res_data[18],
            },
            "DO4": {
                "Id": 4, "Value": res_data[11], "Current": res_data[19],
            },
            "DO5": {
                "Id": 5, "Value": res_data[12], "Current": res_data[20],
            },
            "DO6": {
                "Id": 6, "Value": res_data[13], "Current": res_data[21],
            },
            "DO7": {
                "Id": 7, "Value": res_data[14], "Current": res_data[22],
            },
            "DO8": {
                "Id": 8, "Value": res_data[15], "Current": res_data[23],
            },
        })
