...
class Analog_Input_Read_All_RequestBase(DE_MCU_Request):
    """
    DE-MCU 아날로그 입력 전체 읽기 요청 PDU 생성 클래스
    """

    name = "ANALOG_READ_ALL_REQ"
    ...
    def serialize(self):
        ...
        try:
            if self.data_length == 0:
                ...
                self.byte_frame += bytes([self.command]) + bytes([self.data_length]) + self.data
...
class Analog_Input_Read_All_Request(Analog_Input_Read_All_RequestBase):
    """
...
class Analog_Input_Read_All_ResponseBase(DE_MCU_Response):
    """
    DE-MCU 아날로그 입력 전체 읽기 응답 PDU 생성 클래스
    """

    name = "ANALOG_READ_ALL_RES"
...
class Analog_Input_Read_All_Response(Analog_Input_Read_All_ResponseBase):
    """
    DE-MCU 아날로그 입력 전체 읽기 응답 PDU 생성 클래스
    """
    ...
    def deserialize(self, data):
        ...
        processed_data.setdefault("STATUS", {}).setdefault("Voltage", {
            "AV1": {
                "Id": 1, "Value": res_data[0], "Unit": "mV",
            },
            "AV2": {
                "Id": 2, "Value": res_data[1], "Unit": "mV",
            },
            "AV3": {
                "Id": 3, "Value": res_data[2], "Unit": "mV",
            },
            "AV4": {
                "Id": 4, "Value": res_data[3], "Unit": "mV",
            },
        })
        processed_data.setdefault("STATUS", {}).setdefault("Current", {
            "AI1": {
                "Id": 1, "Value": res_data[4], "Unit": "uA",
            },
            "AI2": {
                "Id": 2, "Value": res_data[5], "Unit": "uA",
            },
            "AI3": {
                "Id": 3, "Value": res_data[6], "Unit": "uA",
            },
            "AI4": {
                "Id": 4, "Value": res_data[7], "Unit": "uA",
            },
        })
