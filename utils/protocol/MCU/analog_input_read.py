...
class Analog_Input_Read_RequestBase(DE_MCU_Request):
    """
    DE-MCU 아날로그 입력 읽기 요청 PDU 생성 클래스
    """

    name = "ANALOG_READ_REQ"
...
class Analog_Input_READ_Request(Analog_Input_Read_RequestBase):
    """
    DE-MCU 아날로그 입력 읽기 요청 PDU 생성 클래스 (serial_number를 HEX 문자열로 입력받음)
    """
...
class Analog_Input_Read_ResponseBase(DE_MCU_Response):
    """
    DE-MCU 아날로그 입력 읽기 응답 PDU 생성 클래스
    """

    name = "ANALOG_READ_RES"
...
class Analog_Input_Read_Response(Analog_Input_Read_ResponseBase):
    """
    DE-MCU 아날로그 입력 읽기 응답 PDU 생성 클래스 (serial_number를 HEX 문자열로 입력받음)
    """
